...
typedef enum _KinectCapabilities
    {
...
typedef enum _FrameSourceTypes
    {
...
typedef enum _ColorImageFormat
    {
...
typedef enum _FrameCapturedStatus
    {
...
typedef enum _KinectAudioCalibrationState
    {
...
typedef enum _PointerDeviceType
    {
